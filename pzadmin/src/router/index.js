...
const routes = [
  {
    ...
    // redirect: to => {
    //   if (localStorage.getItem('asideScale')) {
    //     // 是否有二级菜单
    //     const child = JSON.parse(localStorage.getItem('asideScale')).menu.routerList[0].children
    //     if (child) {
    //       return child[0].meta.path
    //     } else {
    //       return JSON.parse(localStorage.getItem('asideScale')).menu.routerList[0].meta.path
    //     }
    //   } else {
    //     return '/login'
    //   }
